...
from lib.tracker.lighttrack_uav import Lighttrack
#from lib.tracker.lighttrack_trt_ori import Lighttrack
...
parser.add_argument('--name', default='lighttrack-trtori', type=str,
